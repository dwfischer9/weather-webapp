    ...
    request(url, function(err, response, body) {
        ...
        if (err) {
            ...
            if (weather.main == undefined) {
                ...
                feels_like_fah = ((feels_like * 9 / 5) + 32);
                ...
                feels_like_fah = roundToTwo(feels_like_fah);
                // We shall now render the data to our page (index.ejs) before displaying it out
                res.render('index', { feels_like: feels_like, weather: weather, place: place, temp: weatherTemp, pressure: weatherPressure, icon: weatherIcon, description: weatherDescription, timezone: weatherTimezone, humidity: humidity, fahrenheit: weatherFahrenheit, clouds: clouds, visibility: visibility, main: main, error: null });
            }
        }
    });
});
